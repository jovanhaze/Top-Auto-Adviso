        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[70vh]">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a 
                href="#pricing" 
                className="bg-emerald hover:bg-emerald-600 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-lg text-center"
              >
              ...
              <a 
                href="#how-it-works" 
                className="border-2 border-white text-white hover:bg-white hover:text-navy px-8 py-4 rounded-xl font-semibold text-lg transition-all text-center"
              >
                See How It Works
              </a>
            </div>
